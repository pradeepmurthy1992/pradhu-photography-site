...
export default function MobileActionFab({ hide }) {
  ...
  const calHref = `${CALENDLY_URL}${CALENDLY_URL.includes("?") ? "&" : "?"}utm_source=site&utm_medium=fab&utm_campaign=booking`;
    ...
    <div className="sm:hidden fixed right-3 bottom-4 z-[75]">
      ...
      <div
        className={[
          ...
          open ? "w-[360px] opacity-100 translate-y-0" : "w-0 opacity-0 translate-y-2 pointer-events-none"
        ].join(" ")}
        aria-hidden={!open}
      >
        <div className="flex divide-x">
          ...
          <a
            ...
            onClick={() => {
              setOpen(false);
              trackEvent("cta_click", { location: "mobile_fab", cta: "calendly" });
            }}
          >
            Schedule
          </a>
